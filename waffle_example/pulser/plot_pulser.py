...
def main(dir_name, num_samples=2000, sample_dec=1 ):
    ...
    summary = TrainingResultSummary(dir_name, num_samples, int(sample_dec), model_type="PulserTrainingModel")
    summary.extract_model_values()
    summary.summarize_params()
    # exit()

    plotter = TrainingPlotter(dir_name, num_samples, int(sample_dec), model_type="PulserTrainingModel")
